...
/**
 * Static properties for the Bill ontology bill stages SKOS schema
 */
public final class BillStage {

    protected static final String uri = "http://linked.opendata.cz/ontology/legislation/bill-legislative-stages#";
    /**
